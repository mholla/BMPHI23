...
c      enddo       
      ...
      do intpt=1,nIntPt
         ...
         ! here I need to calculate the coords at this integration point
         !  
         Coord_integ = matmul(Nvec,transpose(CoordsC))
         ...
         !       
         call integ(props,nprops,dtime,Coord_integ,
     +     u_tau,u_t,v_tau,v_t,
...
************************************************************************
      subroutine integ(props,nprops,dtime,Coord_integ,
     +     u_tau,u_t,v_tau,v_t,
     +     Diff_u,Diff_v,F_const,k_const,sigma,permittivity,
     +     c_t,c_tau)      
      ...
      real*8 F_min,F_max,k_min,k_max,x_max,y_max
      real*8 Coord_integ(1,2)
     ...
     +     half=1.d0/2.d0)
      ...
      gamma          = props(11)
      sigma          = props(12)
      permittivity   = props(13)
      
      ! here make a k(x), F(y) functions 
      ! 
      k_const = k_min + ((k_max-k_min)/x_max)*Coord_integ(1,1)
      F_const = F_min + ((F_max-F_min)/y_max)*Coord_integ(1,2)      
